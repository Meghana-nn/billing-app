...
export const startCreateProduct = (formData, resetForm) => {
    return async (dispatch) => {
        try {
            const response = await axios.post('http://localhost:3006/api/products', formData)
...
export const startUpdateProduct = (id, formData, resetForm, toggle) => {
    return async (dispatch) => {
        try {
            const response = await axios.put(`http://localhost:3006/api/products/${id}`, formData) 
...
export const startRemoveProduct = (id) => {
    return async (dispatch) => {
        try {
            const response = await axios.delete(`http://localhost:3006/api/products/${id}`)
