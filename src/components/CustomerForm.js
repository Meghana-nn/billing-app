...
export default function CustomerForm(props){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
        if(customer){
            const response = await axios.put(`http://localhost:3006/api/customers/${customer._id}`, formData) 
            ...
            const response = await axios.post('http://localhost:3006/api/customers', formData)
